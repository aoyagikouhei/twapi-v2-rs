...
const URL: &str = "/2/users/:source_user_id/blocking/:target_user_id";
...
impl Api {
    ...
    pub fn build(&self, authentication: &impl Authentication) -> RequestBuilder {
        ...
        let url = make_url(&self.twapi_options, &URL.replace(":source_user_id", &self.source_user_id).replace(":target_user_id", &self.target_user_id));
        let builder = client
            .delete(&url)
        ;
