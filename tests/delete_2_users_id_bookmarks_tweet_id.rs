use anyhow::Result;
use twapi_v2::api::{delete_2_users_id_bookmarks_tweet_id, execute_twitter, BearerAuthentication};
...
async fn test_delete_2_users_id_bookmarks_tweet_id() -> Result<()> {
    ...
    let builder = delete_2_users_id_bookmarks_tweet_id::Api::new("1660518823991336966", &tweet_id)
        .build(&bearer_auth);
