use anyhow::Result;
use chrono::prelude::*;
use twapi_v2::api::{execute_twitter, post_2_dm_conversations_dm_conversation_id_message};
...
async fn test_post_2_dm_conversations_dm_conversation_id_message() -> Result<()> {
    ...
    let builder = post_2_dm_conversations_dm_conversation_id_message::Api::new(
        &bearer_code,
        &dm_conversation_id,
        body,
    )
