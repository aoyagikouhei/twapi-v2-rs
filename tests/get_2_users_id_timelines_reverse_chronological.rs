use anyhow::Result;
use twapi_v2::api::{execute_twitter, get_2_users_id_timelines_reverse_chronological, BearerAuth};
...
async fn test_get_2_users_id_timelines_reverse_chronological() -> Result<()> {
    ...
    let builder = get_2_users_id_timelines_reverse_chronological::Api::open("1660518823991336966")
        .build(&bearer_auth);
