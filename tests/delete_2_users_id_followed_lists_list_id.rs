use anyhow::Result;
use twapi_v2::api::{
    BearerAuthentication, delete_2_users_id_followed_lists_list_id, execute_twitter,
};
...
async fn test_delete_2_users_id_followed_lists_list_id() -> Result<()> {
    ...
    let bearer_auth = BearerAuthentication::new(bearer_code);    let (res, _rate_limit) = execute_twitter::<serde_json::Value>(|| delete_2_users_id_followed_lists_list_id::Api::new("1660518823991336966", &list_id)
