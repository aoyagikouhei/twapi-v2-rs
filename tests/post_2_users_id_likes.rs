use anyhow::Result;
use twapi_v2::api::{execute_twitter, post_2_users_id_likes, BearerAuthentication};
...
async fn test_post_2_users_id_likes() -> Result<()> {
    ...
    let builder = post_2_users_id_likes::Api::new("1660518823991336966", body).build(&bearer_auth);
