use anyhow::Result;
use twapi_v2::api::{execute_twitter, post_2_users_id_muting};

// BEARER_CODE=XXXXX ME_ID=XXXX TARGET_USER_ID=XXXXX cargo test test_post_2_users_id_muting -- --nocapture --test-threads=1
...
async fn test_post_2_users_id_muting() -> Result<()> {
    ...
    let builder = post_2_users_id_muting::Api::new(&bearer_code, &me_id, body).build();
