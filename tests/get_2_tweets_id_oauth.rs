...
// CONSUMER_KEY=XXXX CONSUMER_SECRET=XXXX ACCESS_KEY=XXXX ACCESS_SECRET=XXXX cargo test test_get_2_tweets_id_oauth -- --nocapture --test-threads=1
...
async fn test_get_2_tweets_id_oauth() -> Result<()> {
    ...
    let builder = get_2_tweets_id::Api::open("1683460166149357568").build(&auth);
