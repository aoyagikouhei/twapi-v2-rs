...
// BEARER_CODE=XXXXX ME_ID=XXXX TARGET_USER_ID=XXXXX cargo test test_post_2_users_id_following -- --nocapture --test-threads=1
...
async fn test_post_2_users_id_following() -> Result<()> {
    ...
    let builder = post_2_users_id_following::Api::new(&bearer_code, &me_id, body).build();
